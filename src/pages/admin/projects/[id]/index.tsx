              ...
              <div className="bg-slate-800 rounded-xl p-8 border border-slate-700 shadow relative">
                <div className="absolute top-8 right-8 flex gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-pink-600 text-white font-semibold px-4 py-2 rounded-lg shadow hover:from-red-700 hover:to-pink-700 transition-colors"
                  >
